import { remove, getList, save, update } from '@/api/system/userInfo'
    ...
    save() {
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          if (this.form.id !== '') {
            update({ id: self.form.id, userName: userName, dictValues: dictValues }).then(response => {
              this.$message({
                message: '提交成功',
                type: 'success'
              })
            ...
            save({ userName: userName, dictValues: dictValues }).then(response => {
              this.$message({
                message: '提交成功',
                type: 'success'
              })
